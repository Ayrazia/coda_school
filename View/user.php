<a href="index.php?component=users" style="text-decoration: none;">
    <i class="fa-solid fa-arrow-left fa-xl" style="font-size: medium;"></i>
    <span style="margin-left: 10px;">Retour sans modification</span>
</a>
